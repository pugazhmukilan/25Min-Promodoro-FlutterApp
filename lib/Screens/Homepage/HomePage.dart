    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          ThemeIcon(
            onToggle:
                widget.toggleTheme, // Pass the toggle function to ThemeIcon
          ),
        ],
      ),
      body: Column(
        ...
        children: [
              ...
              children: [
                Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      mainAxisAlignment:
                          MainAxisAlignment.center, // Align children to the top
          ...
          Expanded(
            child: SessionGraph(
              efficiencies: [80, 65, 70, 90, 30, 85, 60, 55, 95, 88],
            ),
          ),
                  ...
                  child: Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        mainAxisAlignment:
                            MainAxisAlignment
                                .center, // Align children to the top
                        crossAxisAlignment: CrossAxisAlignment.center,
                        children: [
                          Text(
                            "Create",
